...
result example:
```
{"access_token":"O1IToLcM5UHu_TwQ_l8R_b_04Xf0zHIP"}
```
...
result example: 
```
[{"id":5,"title":"rock"},{"id":6,"title":"hard rock"}]
```
...
Content-Type: multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW
```
empty result. if was exception, result will be like: 
```
{"name":"Not Found","message":"Object not found: 6","code":0,"status":404,"type":"yii\\web\\NotFoundHttpException"}
```
==================================================================================
...
result example: 
```
[{"id":9,"title":"indie"},{"id":5,"title":"hard rock"},{"id":8,"title":"alternative"}]
```
Sort ASC by title:
```
GET /v1/categories?sort=title HTTP/1.1
...
result example: 
```
{"title":"Nightwish","category_id":"5","id":1}
```
...
result example: 
```
{"title":"Nightwish","category_id":"8","id":1}
```
title:
```
PUT /v1/products/1 HTTP/1.1
...
result example: 
```
{"id":1,"category_id":"8","title":"Nightwish111"}
```
...
result example: 
```
[{"id":1,"category_id":8,"title":"Nightwish111"},{"id":2,"category_id":8,"title":"Nightwish"}]
```
...
result example: 
```
{"id":2,"category_id":8,"title":"Nightwish"}
```
==================================================================================
...
result example: 
```
[{"id":2,"category_id":8,"title":"Nightwish"},{"id":3,"category_id":8,"title":"Epica"}]
```
==================================================================================
